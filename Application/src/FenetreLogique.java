...
public class FenetreLogique extends JFrame {
	...
	private JLabel label = new JLabel("<html><br><center><U>Description de l'épreuve</U><br><br>Cette épreuve de "
			+ "logique repose sur la célèbre suite de Fibonacci.<br><br>Il s'agit d'une suite linéaire d'ordre 2 qui "
			+ "fonctionne de la manière suivante : <br>U(n+2) = U(n+1) + U(n)<br><br>"
			...
			+ "Le créateur de l'épreuve doit choisir les deux premiers éléments de la suite et le nombre d'éléments souhaités.<br><br><center></html>");
